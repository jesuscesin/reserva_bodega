...
function repuestos_malos($articulo, $cantidadanalizada, $cantidad, $bodega_origen){
...
function repuestos_buenos($articulo, $cantidadanalizada, $cantidad, $bodega_origen){
...
function repuestos_pendientes($articulo, $cantidadanalizada, $bodega_origen){
...
if ($stock == $cantidadanalizada){
	...
	if($cantidadanalizada == $cantidad){
		...
		delete_reserva($bodega_origen,$articulo);
		repuestos_malos($articulo, $cantidadanalizada, $cantidad, $bodega_origen);
	}else{
		delete_reserva($bodega_origen,$articulo);
		actualiza_stock($cantidad,$articulo, $bodega_origen);
		repuestos_buenos($articulo, $cantidadanalizada, $cantidad, $bodega_origen);
		repuestos_malos($articulo, $cantidadanalizada, $cantidad, $bodega_origen);
	}
}elseif ($stock > $cantidadanalizada){
	if($cantidadanalizada == $cantidad){
		delete_reserva($bodega_origen,$articulo);
		actualiza_stock($cantidad,$articulo, $bodega_origen);
		repuestos_buenos($articulo, $cantidadanalizada, $cantidad, $bodega_origen);
		repuestos_pendientes($articulo, $cantidadanalizada, $bodega_origen);
	}elseif($cantidad == 0){
		delete_reserva($bodega_origen,$articulo);
		repuestos_malos($articulo, $cantidadanalizada, $cantidad, $bodega_origen);
		repuestos_pendientes($articulo, $cantidadanalizada, $bodega_origen);
...
if(isset($_GET["valida_resto"])){
    ...
    valida_resto($articulo_salida,$articulo_entrada,$cantidad,$cantidadanalizada);
}
if(isset($_GET["recno"])){
	//$bodega = $_GET['bodega_origen'];
	//tmp_nrotrabajador();
...
if(isset($_GET["confirma_traspaso"])){
	...
	//ver_pedido_impreso($numero, $articulo, $bodega_origen,  $cantidad, $cantidadanalizada);
