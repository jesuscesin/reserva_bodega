...
function onLoad() {
      ...
      get_fecha();
      $("#btn_confirmar").click(confirmar_trapaso);
      get_count();
}
...
function confirmar_trapaso() { //REMOVER ASIGNACION INGRESADA,NO DE LA BD
    //alert($(this).attr('cod'));
   ...
   swal.fire({
      ...
      .then((confirmacion) => {
            if (confirmacion) {
                 ...
                 dataType: 'text',
                 //contentType: false,
                 data:{'confirma_traspaso':'confirma_traspaso','numero':numero , 'articulo':articulo , 'bodega_origen':bodega_origen , ' cantidad' :cantidad},
